...
# 				printIntro()
#
# Function to print the answer title of the program (in sweet ASCII art) and 
# the input data. Takes in a People object. Uses printPeople() function.
def printIntro(people):
	print "# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #"
	print "#   ____                                                        #" 
	print "#  (|   \ o                                  o                  #"
...
def printWeekSolution(week):
	for day in range(DINNERS_PER_WEEK):
		...
		if (day % 2) == 1: print
	print "Week solution fitness: " + str(week.fitness) + " - Guest Att. " \
		+ str(week.guestAttendance[0:3])
